...
export default function CurrencyLogo({
  ...
  if (currency === ETHER) {
    return <StyledBnbLogo src="https://assets-cdn.trustwallet.com/blockchains/smartchain/assets/0x2170Ed0880ac9A755fd29B2688956BD959F933F8/logo.png" size={size} style={style} />
  }
